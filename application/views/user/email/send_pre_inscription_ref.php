<html>
<body>
	<h1 style="font-size:18px;font-family:'Arial',sans-serif;color:#8e2c86;">Demande d'inscription scène,</h1>
	<p style="font-size:15px;font-family:'Arial',sans-serif;color:#3a3a3a;"><strong>Ambassador : </strong><?=$ambassador?></p>
