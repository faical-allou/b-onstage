...
<div style="width:device-width; initial-scale=1; padding: 20px; text-align: justify; font-family: arial; font-size: 16px;background: #676767;">
	...
	<p style="font-size:15px;font-family:'Arial',sans-serif;color:#3a3a3a;font-weight:bold;"><?=anchor($url_new_reservation, ucfirst (lang("users_rese_refuse_email_txt5")),array('style'=>'color:#8e2c86;'))?></p>		
