...
<div id="artist">
	...
	<div class="container_12">	
		<div class="grid_9 mb-20">	
			<!--artists list-->
			<div class="bs-black">
				<div class="fs-16 p-10 white title bg-purple ui-corner-top">Résultats de la recherche</div> 
			...
			<?php if($nb_pages > 1) {?>
			<div class="mt-20">
				<button id="show-more-artists" style="width:100%;">Afficher plus d'artistes / groupes</button>
