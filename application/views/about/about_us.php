	...
	<div class="grid_12 bg-white bs-black ui-corner-all mt-20 mb-20">		
		<div class="p-r">
			...
			if ($this->session->userdata('site_lang') == "english") { 
				echo img(array('src' => site_url('img/about-us-english.jpg'), 'class'=> 'ui-corner-top', 'width' => '100%'));
			} 
			// French - Default
			else {
				echo img(array('src' => site_url('img/about-us.jpg'), 'class'=> 'ui-corner-top', 'width' => '100%'));
			}
			?>
			<ul id="about-menu">
