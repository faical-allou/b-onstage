...
class Event_model extends CI_Model
{
	...
	public function get_all($status='', $date_from='', $date_to='', $city='', $user_id='',$per_page=25, $page = 1){
		...
		$this->db->select('events.*,
					...
					stage.room_size as stage_room_size,stage.stage_size as stage_stage_size,stage.microphone as stage_microphone,stage.speakers as stage_speakers,stage.amplification as stage_amplification, stage.lights as stage_lights, stage.noise as stage_noise')
