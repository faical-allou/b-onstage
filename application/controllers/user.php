			...
			switch($step_value)
			{
				...
				case 1:
					if ($this->ion_auth->logged_in()){
						...
						$header = array(		
							'title'			=> 'Inscription',
							'description'	=> 'Recherchez des sc�nes o� jouer. Trouvez des groupes et artistes pour vos soir�es. D�couvrez les concerts sur Paris, Montr�al, Berlin, Los Angeles.'
						);		
				...
				case 2 :
					if ($this->ion_auth->logged_in()){
						...
						$header['description'] = 'Recherchez des sc�nes o� jouer. Trouvez des groupes et artistes pour vos soir�es. D�couvrez les concerts sur Paris, Montr�al, Berlin, Los Angeles.';
